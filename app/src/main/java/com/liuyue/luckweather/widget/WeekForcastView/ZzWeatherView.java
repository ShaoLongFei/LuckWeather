package com.liuyue.luckweather.widget.WeekForcastView;
...
public class ZzWeatherView extends HorizontalScrollView {
    ...
    private int dayLineColor = Color.RED;
    private int nightLineColor = Color.BLUE;
    ...
    public List<WeekWeatherModel> getList() {
        return list;
    }
    ...
    public void setList(final List<WeekWeatherModel> list) {
        this.list = list;
        ...
        for (int i = 0; i < list.size(); i++) {
            WeekWeatherModel model = list.get(i);
    ...
    private int getMinDayTemp(List<WeekWeatherModel> list) {
        if (list != null) {
    ...
    private int getMinNightTemp(List<WeekWeatherModel> list) {
        if (list != null) {
    ...
    private int getMaxNightTemp(List<WeekWeatherModel> list) {
        if (list != null) {
    ...
    private int getMaxDayTemp(List<WeekWeatherModel> list) {
        if (list != null) {
    ...
    private static class DayTempComparator implements Comparator<WeekWeatherModel> {

        @Override
        public int compare(WeekWeatherModel o1, WeekWeatherModel o2) {
    ...
    private static class NightTempComparator implements Comparator<WeekWeatherModel> {
    ...
    public interface OnWeatherItemClickListener {
        void onItemClick(WeatherItemView itemView, int position, WeekWeatherModel weekWeatherModel);
    }
